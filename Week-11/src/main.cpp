...
#define BLYNK_TEMPLATE_ID "TMPL6AOOxbAAy"
#define BLYNK_TEMPLATE_NAME "DHT by Malaika"
#define BLYNK_AUTH_TOKEN "rUcR5TkHx0reyXObfleitRdN9Z6LuqZK"
